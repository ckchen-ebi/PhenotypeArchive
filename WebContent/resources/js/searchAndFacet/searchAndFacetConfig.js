...
//config.solrBaseURL_ebi = "http://wwwdev.ebi.ac.uk/mi/impc/dev/solr/";
...
//config.dataTablePath = ebiRoot + trailingPathDataTable;
//config.dataTablePath = "http://ves-ebi-d0.ebi.ac.uk:8080/phenotype-archive-dev/dataTable";
...
config.facetParams = {	
	 geneFacet:      {
		 ...
		 params: {fq:'marker_type_str:* -marker_type_str:"heritable phenotypic marker"',			      
			      qf:"marker_symbol^100.0 marker_name^10.0 allele^10 synonym mgi_accession_id auto_suggest",
